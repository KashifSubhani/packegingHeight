...
export const PremiumFinishesData = [
  { name: "Debossing", img: p1 },
  { name: "Embossing", img: p2 },
  { name: "Gloss Lamination", img: p3 },
  { name: "Matt Lamination", img: p4 },
  { name: "Soft Touch Lamination", img: p5 },
